...
void main_window::setup_edit_menu()
{
    ...
    // Cursor line/column: update the status bar on every cursor movement
...
// Cursor line / column indicator
// Extends the existing status bar with cursor position info.
